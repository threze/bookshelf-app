...
const InfoLivro = ({match}) => {
    ...
    useEffect(() => {
      axios
        .get('/api/livros/' + match.params.id)
        .then(res => {
          setData(res.data)
        })
    }, [match.params.id])
              ...
              <div className="row h-100 align-items-center">
                ...
                <div className="col-9">
                  ...
                  <div className="lead text-white">
                    <Badge color='primary'>Lendo</Badge>
                    <Badge color='success'>Lido</Badge>
                    <Badge color='warning'>A ler</Badge>
